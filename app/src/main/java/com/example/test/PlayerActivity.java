...
import static com.example.test.VideoAdapter.videoFiles;
import static com.example.test.VideoFolderAdapter.folderVideoFiles;
...
public class PlayerActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (path!=null){
            ...
            DataSource.Factory factory=new DefaultDataSourceFactory(this, Util.getUserAgent(this,"Test"));
